  ...
  class Mapper
    def mount_carnival_at(mount_location)
      scope mount_location do
        get "carnival-base/load_dependent_select_options/:model/:field/:dependency_field/:dependency_value" => 'carnival/base_admin#load_dependent_select_options', as: :load_dependent_select_options
