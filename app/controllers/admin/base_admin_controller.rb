  ...
  class BaseAdminController < InheritedResources::Base
    ...
    def index
      ...
      respond_to do |format|
        ...
        format.pdf do
          render :pdf => t("#{@datatable.model.to_s.underscore}.lista") , :template => 'admin/index.pdf.haml',  :show_as_html => params[:debug].present?
        end
      end
    end
    ...
    def show
      ...
      show! do |format|
        format.html{render '/admin/shared/form/show'}
      end
    end
    ...
    def new
      ...
      new! do |format|
        ...
        format.html{render '/admin/shared/form/new'}
      end
    end
    ...
    def edit
      ...
      edit! do |format|
        @model = instance_variable_get("@#{controller_name.classify.underscore}")
        format.html{render '/admin/shared/form/edit'}
      end
    end
